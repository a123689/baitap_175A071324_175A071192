        ...
        <td><p>&nbsp;</p>
		  ...
		  ?>
              ...
              <tr>
                ...
                <td><a href="suatheloai.php?idtheloai={idtheloai}">Sửa</a>- <a onclick="return confirm('Bạn có chắc là muốn xóa không ?')" href="xoatheloai.php?idtheloai={idtheloai}&iddanhmuc={iddanhmuc}">Xóa</a></td>
              </tr>
