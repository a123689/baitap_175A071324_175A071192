...
<?php
 ...
 $rowchitiet = chitietslide($idslide);
 ?>
      ...
      $("#btnThem").click(function(){
        ...
        if(tieude == ""){
          ...
          if(!regextieude.test(tieude)){
           ...
           if(hinhanh == ""){
             $.post("kiemtrasuaslide.php",{idslide:"<?php echo $rowchitiet["idslide"]?>",tieude:$('#tieude').val()},function(data){
                if(data == "true"){
                   ...
                   $.ajax({
                       ...
                       success: function (res) {
                         if(res == false){
                           ...
                           $.post("kiemtrasuaslide.php",{idslide:"<?php echo $rowchitiet["idslide"]?>",tieude:$('#tieude').val(),hinhanh:res,hinhcu:"<?php
                            echo $_GET["hinhanh"];?>"},function(data){
                              if(data == "true"){
                                alert('Sửa thành công');
                                let url = 'http://192.168.64.2/baitaplon/baitap_175A071324_175A071192/Quantri/listslide.php';
                               $('#formthemdanhmuc').prop('action',url);
