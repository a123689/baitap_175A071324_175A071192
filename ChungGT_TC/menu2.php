                    ...
                    <div class="col-lg-9 row">
                        ...
                        <div class="col-lg-4 ">
                            <ul class="subnav">
                                ...
                                <li><a href=""><i class="fa fa-angle-double-right"></i>Khối Kỹ thuật - Công nghệ</a>
                                </li>

                                <li><a href=""><i class="fa fa-angle-double-right"></i>Khối Khoa học xã hội - Nhân
                                        văn</a>
                                </li>

                                <li><a href=""><i class="fa fa-angle-double-right"></i>Khối Mỹ thuật - Nghệ thuật</a>
                                </li>
                        ...
                        <div class="col-lg-4">
                            <ul class="subnav">
                                ...
                                <li><a href=""><i class="fa fa-angle-double-right"></i>Ban liên lạc Cựu sinh viên</a>
                                </li>
                        ...
                        <div class=" col-lg-4">
                            <ul class="subnav">
                                ...
                                <li><a href=""><i class="fa fa-angle-double-right"></i>Viện - Trung tâm nghiên cứu</a>
                                </li>
